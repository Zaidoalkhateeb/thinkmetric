...
function WhatsAppButton() {
  return (
    <div className="floating-contact">
      <a href={contact.phoneHref} className="floating-contact__btn" aria-label="Call ThinkMetric">
      ...
      <a
        ...
        aria-label="Chat with ThinkMetric on WhatsApp"
      >
